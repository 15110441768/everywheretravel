...
public class HomeModel extends BaseModel {
    ...
    public void getHomeData(int page, final CallBack<MainContentBean> callBack) {
        MyService service = HttpUtils.getInstance().getApiserver(MyService.homeUrl, MyService.class);
        service.getHomeData(page).compose(RxUtils.<MainContentBean>rxObserableSchedulerHelper())
